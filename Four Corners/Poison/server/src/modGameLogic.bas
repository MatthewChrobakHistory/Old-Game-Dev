...
Dim X As Long, Y As Long, i As Long
    ...
    If GetPlayerEquipment(index, Weapon) = 0 Then
        If Npc(index).WeaponReq > 0 Then
            Call PlayerMsg(index, "You need a special weapon to attack this NPC!", Yellow)
            Exit For
        End If
    End If
    ...
    If GetPlayerEquipment(index, Shield) = 0 Then
        If Npc(index).ShieldReq > 0 Then
            Call PlayerMsg(index, "You need a special type of shield to attack this NPC!", Yellow)
            Exit For
        End If
    End If
    ...
    If GetPlayerEquipment(index, Helmet) = 0 Then
        If Npc(index).HelmetReq > 0 Then
            Call PlayerMsg(index, "You need a special type of helmet to attack this NPC!", Yellow)
            Exit For
        End If
    End If
    ...
    If GetPlayerEquipment(index, Armor) = 0 Then
        If Npc(index).HelmetReq > 0 Then
            Call PlayerMsg(index, "You need a special type of body armor to attack this NPC!", Yellow)
            Exit For
        End If
    End If
    ...
    If GetPlayerEquipment(index, Legs) = 0 Then
        If Npc(index).HelmetReq > 0 Then
            Call PlayerMsg(index, "You need a special type of leg armor to attack this NPC!", Yellow)
            Exit For
        End If
    End If
