...
Dim attackspeed As Long
    ...
    ' sprite 1,7,13 = male standing
    ' sprite 4,10,16 = female standing
    ' sprite 2,8,14 = male shield stance
    ' sprite 5,11,17 = female shield stance
    ' sprite 3,9,15 = male 2h stance
    ' sprite 6,12,18 = female 2h stance
    ...
    For i = 1 To UBound(PaperdollOrder)
        ...
        If GetPlayerEquipment(Index, Helmet) > 0 Then
            'male standing
            If Player(Index).Sprite = 1 Or Player(Index).Sprite = 7 Or Player(Index).Sprite = 13 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll1 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll1, Anim, spritetop)
                End If
            End If
            'female standing
            If Player(Index).Sprite = 4 Or Player(Index).Sprite = 10 Or Player(Index).Sprite = 16 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll2 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll2, Anim, spritetop)
                End If
            End If
            'male shield stance
            If Player(Index).Sprite = 2 Or Player(Index).Sprite = 8 Or Player(Index).Sprite = 14 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll3 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll3, Anim, spritetop)
                End If
            End If
            'female shield stance
            If Player(Index).Sprite = 5 Or Player(Index).Sprite = 11 Or Player(Index).Sprite = 17 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll4 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll4, Anim, spritetop)
                End If
            End If
            'male 2h stance
            If Player(Index).Sprite = 3 Or Player(Index).Sprite = 9 Or Player(Index).Sprite = 15 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll5 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll5, Anim, spritetop)
                End If
            End If
            'female 2h stance
            If Player(Index).Sprite = 6 Or Player(Index).Sprite = 12 Or Player(Index).Sprite = 18 Then
                If Item(GetPlayerEquipment(Index, Helmet)).Paperdoll6 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Helmet)).Paperdoll6, Anim, spritetop)
                End If
            End If
        End If
        ...
        If GetPlayerEquipment(Index, Armor) > 0 Then
            'male standing
            If Player(Index).Sprite = 1 Or Player(Index).Sprite = 7 Or Player(Index).Sprite = 13 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll1 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll1, Anim, spritetop)
                End If
            End If
            'female standing
            If Player(Index).Sprite = 4 Or Player(Index).Sprite = 10 Or Player(Index).Sprite = 16 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll2 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll2, Anim, spritetop)
                End If
            End If
            'male shield stance
            If Player(Index).Sprite = 2 Or Player(Index).Sprite = 8 Or Player(Index).Sprite = 14 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll3 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll3, Anim, spritetop)
                End If
            End If
            'female shield stance
            If Player(Index).Sprite = 5 Or Player(Index).Sprite = 11 Or Player(Index).Sprite = 17 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll4 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll4, Anim, spritetop)
                End If
            End If
            'male 2h stance
            If Player(Index).Sprite = 3 Or Player(Index).Sprite = 9 Or Player(Index).Sprite = 15 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll5 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll5, Anim, spritetop)
                End If
            End If
            'female 2h stance
            If Player(Index).Sprite = 6 Or Player(Index).Sprite = 12 Or Player(Index).Sprite = 18 Then
                If Item(GetPlayerEquipment(Index, Armor)).Paperdoll6 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Armor)).Paperdoll6, Anim, spritetop)
                End If
            End If
        End If
        'legs
        If GetPlayerEquipment(Index, Legs) > 0 Then
            'male standing
            If Player(Index).Sprite = 1 Or Player(Index).Sprite = 7 Or Player(Index).Sprite = 13 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll1 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll1, Anim, spritetop)
                End If
            End If
            'female standing
            If Player(Index).Sprite = 4 Or Player(Index).Sprite = 10 Or Player(Index).Sprite = 16 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll2 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll2, Anim, spritetop)
                End If
            End If
            'male shield stance
            If Player(Index).Sprite = 2 Or Player(Index).Sprite = 8 Or Player(Index).Sprite = 14 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll3 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll3, Anim, spritetop)
                End If
            End If
            'female shield stance
            If Player(Index).Sprite = 5 Or Player(Index).Sprite = 11 Or Player(Index).Sprite = 17 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll4 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll4, Anim, spritetop)
                End If
            End If
            'male 2h stance
            If Player(Index).Sprite = 3 Or Player(Index).Sprite = 9 Or Player(Index).Sprite = 15 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll5 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll5, Anim, spritetop)
                End If
            End If
            'female 2h stance
            If Player(Index).Sprite = 6 Or Player(Index).Sprite = 12 Or Player(Index).Sprite = 18 Then
                If Item(GetPlayerEquipment(Index, Legs)).Paperdoll6 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Legs)).Paperdoll6, Anim, spritetop)
                End If
            End If
        End If
        'shield
        If GetPlayerEquipment(Index, Shield) > 0 Then
            'male standing
            If Player(Index).Sprite = 1 Or Player(Index).Sprite = 7 Or Player(Index).Sprite = 13 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll1 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll1, Anim, spritetop)
                End If
            End If
            'female standing
            If Player(Index).Sprite = 4 Or Player(Index).Sprite = 10 Or Player(Index).Sprite = 16 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll2 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll2, Anim, spritetop)
                End If
            End If
            'male shield stance
            If Player(Index).Sprite = 2 Or Player(Index).Sprite = 8 Or Player(Index).Sprite = 14 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll3 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll3, Anim, spritetop)
                End If
            End If
            'female shield stance
            If Player(Index).Sprite = 5 Or Player(Index).Sprite = 11 Or Player(Index).Sprite = 17 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll4 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll4, Anim, spritetop)
                End If
            End If
            'male 2h stance
            If Player(Index).Sprite = 3 Or Player(Index).Sprite = 9 Or Player(Index).Sprite = 15 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll5 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll5, Anim, spritetop)
                End If
            End If
            'female 2h stance
            If Player(Index).Sprite = 6 Or Player(Index).Sprite = 12 Or Player(Index).Sprite = 18 Then
                If Item(GetPlayerEquipment(Index, Shield)).Paperdoll6 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Shield)).Paperdoll6, Anim, spritetop)
                End If
            End If
        End If
        'weapon
        If GetPlayerEquipment(Index, Weapon) > 0 Then
            'male standing
            If Player(Index).Sprite = 1 Or Player(Index).Sprite = 7 Or Player(Index).Sprite = 13 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll1 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll1, Anim, spritetop)
                End If
            End If
            'female standing
            If Player(Index).Sprite = 4 Or Player(Index).Sprite = 10 Or Player(Index).Sprite = 16 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll2 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll2, Anim, spritetop)
                End If
            End If
            'male shield stance
            If Player(Index).Sprite = 2 Or Player(Index).Sprite = 8 Or Player(Index).Sprite = 14 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll3 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll3, Anim, spritetop)
                End If
            End If
            'female shield stance
            If Player(Index).Sprite = 5 Or Player(Index).Sprite = 11 Or Player(Index).Sprite = 17 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll4 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll4, Anim, spritetop)
                End If
            End If
            'male 2h stance
            If Player(Index).Sprite = 3 Or Player(Index).Sprite = 9 Or Player(Index).Sprite = 15 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll5 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll5, Anim, spritetop)
                End If
            End If
            'female 2h stance
            If Player(Index).Sprite = 6 Or Player(Index).Sprite = 12 Or Player(Index).Sprite = 18 Then
                If Item(GetPlayerEquipment(Index, Weapon)).Paperdoll6 > 0 Then
                    Call BltPaperdoll(x, Y, Item(GetPlayerEquipment(Index, Weapon)).Paperdoll6, Anim, spritetop)
                End If
            End If
        End If
    Next
