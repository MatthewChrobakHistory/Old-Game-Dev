...
Sub ProcessNpcMovement(ByVal MapNpcNum As Long)
    ...
    If MapNpc(MapNpcNum).Moving = MOVING_WALKING Then
        ...
        Select Case MapNpc(MapNpcNum).Dir
            Case DIR_UP
                MapNpc(MapNpcNum).YOffset = MapNpc(MapNpcNum).YOffset - ((ElapsedTime / 1000) * (4 * SIZE_X))
            ...
            Case DIR_LEFT
                MapNpc(MapNpcNum).XOffset = MapNpc(MapNpcNum).XOffset - ((ElapsedTime / 1000) * (4 * SIZE_X))
...
Public Sub OpenShop(ByVal shopnum As Long)
    ...
    frmMain.picShopItems.Picture = Nothing
    ...
    If Shop(shopnum).ShopType = 1 Then
             frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\smithing.jpg")
             frmMain.imgShopSell.Visible = False
             frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\smithingTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 2 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\cooking.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\cookingTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 3 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\fletching.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\fletchingTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 4 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\crafting.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\craftingTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 5 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\anvil.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\anvilTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 6 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\potionbrewing.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\potionbrewingTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 7 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\watersource.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\watersourceTOP.jpg")
    End If
    
    If Shop(shopnum).ShopType = 8 Then
        frmMain.picShop.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\potteryoven.jpg")
        frmMain.imgShopSell.Visible = False
        frmMain.picShopItems.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\potteryovenTOP.jpg")
    End If
