...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox picSkills 
      ...
      Begin VB.Label lblFishingXP 
         ...
         Width           =   1935
      End
      Begin VB.Label lblWoodcuttingXP 
         BackColor       =   &H80000007&
         Caption         =   "Woodcutting XP: "
         ForeColor       =   &H8000000B&
         Height          =   255
         Left            =   1200
         TabIndex        =   117
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Cancel = True
    If Player(MyIndex).SecOutofCombat = 0 Then
        logoutGame
    Else
        AddText "You must wait " & Player(MyIndex).SecOutofCombat & " more seconds to loggout.", BrightRed
    End If
...
Dim i As Long
    ...
    Select Case Index
        ...
        Case 6
            ...
            PlaySound Sound_ButtonClick
        Case 7
            If picTrade.Visible = True Then Exit Sub
            If picBank.Visible = True Then Exit Sub
            If picShop.Visible = True Then Exit Sub
...
Private Sub picSkillLoad()

lblMiningXP.Caption = "Mining XP: " & Player(MyIndex).MiningXP
lblWoodcuttingXP.Caption = "Woodcutting XP: " & Player(MyIndex).WoodcuttingXP
lblFishingXP.Caption = "Fishing XP: " & Player(MyIndex).FishingXP
lblPotionBrewingXP.Caption = "Potion Brew XP: " & Player(MyIndex).PotionBrewingXP
lblSmithingXP.Caption = "Smithing XP: " & Player(MyIndex).SmithingXP
lblCookingXP.Caption = "Cooking XP: " & Player(MyIndex).CookingXP
lblFletchingXP.Caption = "Fletching XP: " & Player(MyIndex).FletchingXP
lblCraftingXP.Caption = "Crafting XP: " & Player(MyIndex).CraftingXP
...
Private Sub imgShopBuy_Click()
    ...
    If frmMain.imgShopSell.Visible = True Then
        AddText "Click on the item in the shop you wish to purchase.", White
    Else
        AddText "Click on the item you wish to make.", White
    End If
                 ...
                 Case 0 ' no action, give cost
                         If Shop(InShop).ShopType = 0 Then
                                 With Shop(InShop).TradeItem(shopItem)
                                    If .NumCosts = 1 Then AddText "You can buy this item for " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                    If .NumCosts = 2 Then AddText "You can buy this item for " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                                 End With
                         End If
                        
                         If Shop(InShop).ShopType = 1 Or Shop(InShop).ShopType = 5 Then
                                 With Shop(InShop).TradeItem(shopItem)
                                    If .NumCosts = 1 Then AddText "You can smith this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                    If .NumCosts = 2 Then AddText "You can smith this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                                 End With
                         End If
                         
                         If Shop(InShop).ShopType = 2 Then
                            With Shop(InShop).TradeItem(shopItem)
                                If .NumCosts = 1 Then AddText "You can cook this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                If .NumCosts = 2 Then AddText "You can cook this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                            End With
                        End If
                        
                        If Shop(InShop).ShopType = 3 Then
                            With Shop(InShop).TradeItem(shopItem)
                                If .NumCosts = 1 Then AddText "You can fletch this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                If .NumCosts = 2 Then AddText "You can fletch this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                            End With
                        End If
                        
                        If Shop(InShop).ShopType = 4 Then
                            With Shop(InShop).TradeItem(shopItem)
                                If .NumCosts = 1 Then AddText "You can craft this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                If .NumCosts = 2 Then AddText "You can craft this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                            End With
                        End If
                        
                        If Shop(InShop).ShopType > 6 Then
                            With Shop(InShop).TradeItem(shopItem)
                                If .NumCosts = 1 Then AddText "You can make this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & ".", White
                                If .NumCosts = 2 Then AddText "You can make this item with " & .CostValue & " " & Trim$(Item(.CostItem).Name) & " and " & .CostValue2 & " " & Trim$(Item(.CostItem2).Name) & ".", White
                            End With
                        End If
                 Case 1 ' buy item
                         ' buy item code
        ...
        If InShop > 0 Then
            Select Case ShopAction
                Case 0 ' nothing, give value
                    If frmMain.imgShopSell.Visible = False Then Exit Sub
