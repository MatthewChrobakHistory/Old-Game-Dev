...
Public Sub Main()
    ...
    PaperdollOrder(3) = Equipment.Helmet
    PaperdollOrder(4) = Equipment.Armor
...
Dim i As Long
    ...
    'skills
    frmMain.picSkills.Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\skillinfo.jpg")
    frmMain.picSkill(0).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\mining.jpg")
    frmMain.picSkill(1).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\fishing.jpg")
    frmMain.picSkill(2).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\woodcutting.jpg")
    frmMain.picSkill(3).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\potionbrewing.jpg")
    frmMain.picSkill(4).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\smithing.jpg")
    frmMain.picSkill(5).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\cooking.jpg")
    frmMain.picSkill(6).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\fletching.jpg")
    frmMain.picSkill(7).Picture = LoadPicture(App.Path & "\data files\graphics\gui\main\icons\crafting.jpg")
