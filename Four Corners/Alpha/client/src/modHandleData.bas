...
Dim Buffer As clsBuffer
    ...
    Call SetPlayerEquipment(MyIndex, Buffer.ReadLong, Legs)
...
Dim playerNum As Long
    ...
    Call SetPlayerEquipment(playerNum, Buffer.ReadLong, Legs)
...
Dim i As Long
    ...
    Next
        ...
        frmMain.lblCharStat(2).Caption = GetPlayerStat(MyIndex, 2)
        frmMain.lblCharStat(3).Caption = GetPlayerStat(MyIndex, 3)
        frmMain.lblCharStat(4).Caption = GetPlayerStat(MyIndex, 4)
        frmMain.lblCharStat(5).Caption = GetPlayerStat(MyIndex, 5)
...
Dim Buffer As clsBuffer
    ...
    Call SetPlayerPotionBrewingXP(i, Buffer.ReadLong)
    Call SetPlayerSecOutofCombat(i, Buffer.ReadLong)
