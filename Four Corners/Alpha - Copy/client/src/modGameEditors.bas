...
Dim SoundSet As Boolean
    ...
    With Item(EditorIndex)
        ...
        frmEditor_Item.scrlPotionBrewing = .EqPBXP
        frmEditor_Item.scrlPotionBrewingRew = .PBRew
        frmEditor_Item.scrlPotionBrewingXP = .PBXP
...
Dim SoundSet As Boolean
    ...
    With frmEditor_NPC
        ...
        .txtMap.text = Npc(EditorIndex).Map
        .txtX.text = Npc(EditorIndex).x
        .txtY.text = Npc(EditorIndex).Y
        .scrlRewardItem.Value = Npc(EditorIndex).RewardItem
        
        .txtSpeed.text = CStr(Npc(EditorIndex).Speed)
...
Dim SoundSet As Boolean
    ...
    With frmEditor_Spell
        ...
        .scrlMax.Value = Spell(EditorIndex).VitalMax
