...
Public Const EqLeft As Long = 9
Public Const EqOffsetX As Long = 4
...
' Website
Public Const GAME_WEBSITE As String = "http://ludiludo.freemessageboards.com/"
...
Public Const ITEM_TYPE_CONSUME As Byte = 6
Public Const ITEM_TYPE_KEY As Byte = 7
Public Const ITEM_TYPE_CURRENCY As Byte = 8
Public Const ITEM_TYPE_SPELL As Byte = 9
