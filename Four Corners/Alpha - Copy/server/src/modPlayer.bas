...
'XPOISONX
Function GetPlayerPoisonDamage(ByVal index As Long) As Long
If index > MAX_PLAYERS Then Exit Function
    GetPlayerPoisonDamage = Player(index).PoisonDamage
End Function

Function GetPlayerPoisonTick(ByVal index As Long) As Long
If index > MAX_PLAYERS Then Exit Function
    GetPlayerPoisonTick = Player(index).PoisonTick
End Function
