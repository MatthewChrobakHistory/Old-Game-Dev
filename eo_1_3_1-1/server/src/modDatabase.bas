...
Sub AddChar(ByVal index As Long, ByVal Name As String, ByVal Sex As Byte, ByVal ClassNum As Long, ByVal Sprite As Long)
    ...
    If LenB(Trim$(Player(index).Name)) = 0 Then
        ...
        For n = 1 To UBound(Class(ClassNum).StartItem)
        ...
        ' set start spells
        For n = 1 To UBound(Class(ClassNum).StartSpell)
...
Sub LoadClasses()
    ...
    For i = 1 To Max_Classes
        ...
        ReDim Class(i).StartItem(1 To startItemCount)
        ReDim Class(i).StartValue(1 To startItemCount)
        ...
        ReDim Class(i).StartSpell(1 To startSpellCount)
