...
Public Sub InitServer()
    ...
    'If LCase$(Dir(App.Path & "\Data\npcs", vbDirectory)) <> "npcs" Then Call MkDir(App.Path & "\Data\npcs")
    ...
    'If LCase$(Dir(App.Path & "\data\accounts", vbDirectory)) <> "accounts" Then Call MkDir(App.Path & "\data\accounts")
