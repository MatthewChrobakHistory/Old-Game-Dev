...
Dim barWidth As Long
    ...
    If SpellBuffer > 0 Then
        If Spell(PlayerSpells(SpellBuffer)).CastTime > 0 Then
            ...
            barWidth = (GetTickCount - SpellBufferTimer) / ((Spell(PlayerSpells(SpellBuffer)).CastTime * 1000)) * 32
            ' draw bars
...
Dim sRECT As RECT, dRECT As RECT, i As Long, num As String, n As Long
    ...
    For i = 1 To MAX_HOTBAR
        ...
        ' render the letters
        num = "F" & Str(i)
        DrawText frmMain.picHotbar.hDC, dRECT.Left + 2, dRECT.top + 18, num, QBColor(White)
    Next
    ...
    For i = 1 To Equipment.Equipment_Count - 1
        If GetPlayerEquipment(Index, i) > 0 Then
            If Item(GetPlayerEquipment(Index, i)).Paperdoll > 0 Then
                Call BltPaperdoll(x, y, Item(GetPlayerEquipment(Index, i)).Paperdoll, Anim, spritetop)
            End If
        End If
    Next
