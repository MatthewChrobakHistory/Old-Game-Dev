...
Dim Buffer As clsBuffer
    ...
    Exit Sub
errorhandler:
    HandleError "SendJoinParty", "modClientTCP", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
...
Dim Buffer As clsBuffer
    ...
    Exit Sub
errorhandler:
    HandleError "SendLeaveParty", "modClientTCP", Err.Number, Err.Description, Err.Source, Err.HelpContext
    Err.Clear
    Exit Sub
End Sub
